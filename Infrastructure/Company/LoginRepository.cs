    ...
    public class LoginRepository : ILoginRepository
    {
        ...
        public async Task<LoginDetailResponse> GetUserDetailById(LoginMultiUserRequest request)
        {
            ...
            try
            {
                ...
                var companyData = await multi.ReadFirstOrDefaultAsync<Domain.Company>();  // Manoj Change the code
               // var companyData = await multi.ReadFirst<Company>();
