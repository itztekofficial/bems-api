...
namespace Admin.Api.Controllers
{
    ...
    public class PaymentTermController : BaseController
    {
        ...
        /// <param name="PaymentTermService"></param>
        public PaymentTermController(ILogger<PaymentTermController> logger, IPaymentTermService PaymentTermService)
        {
            ...
            _logger.LogInformation("PaymentTermController Initialized");
        }
        ...
        public async Task<ApiResponse<IEnumerable<PaymentTerm>>> GetAll()
        {
            try
            {
                var result = await _PaymentTermService.GetAllAsync();
                return new ApiResponse<IEnumerable<PaymentTerm>>()
                {
            ...
            catch (Exception ex)
            {
                ...
                return new ApiResponse<IEnumerable<PaymentTerm>>() { Status = EnumStatus.Error, Message = ex.Message };
            }
        }
        ...
        public async Task<ApiResponse<PaymentTerm>> GetById(ValueRequest request)
        {
            try
            {
                var result = await _PaymentTermService.GetByIdAsync(request.Id);
                return new ApiResponse<PaymentTerm>()
                {
                    Status = EnumStatus.Success,
                    Data = result,
                };
            ...
            {
                _logger.LogError(ex.Message);
                return new ApiResponse<PaymentTerm>() { Status = EnumStatus.Error, Message = ex.Message };
            }
        }
        ...
        public async Task<ApiResponse<bool>> Create(PaymentTerm PaymentTerm)
        {
            try
            {
                var result = await _PaymentTermService.CreateAsync(PaymentTerm);
        ...
        public async Task<ApiResponse<bool>> Update(PaymentTerm PaymentTerm)
        {
            try
            {
                var result = await _PaymentTermService.UpdateAsync(PaymentTerm);
                return new ApiResponse<bool>()
                {
                    Status = EnumStatus.Success,
                    Data = result,
        ...
        public async Task<ApiResponse<bool>> Delete(DeleteRequest request)
        {
            try
            {
                var result = await _PaymentTermService.DeleteAsync(request);
                return new ApiResponse<bool>()
                {
                    Status = EnumStatus.Success,
                    Data = result,
        ...
        public IActionResult GetAllExport()
        {
            try
            {
                var result = _PaymentTermService.GetAllAsync();
                var res = result.Result.ToList();
                List<PaymentTerm> data = new();
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    {
                        var worksheet = workbook.Worksheets.Add("PaymentTerm");
