...
namespace Core.Util
{
     ...
     */
        ...
        private int GetColourIndex(short index)//64-Automatic,8-Black,9-White
        {
            if (index <= 7)
            {
                return 9;
        ...
        protected String BuildStyle(IWorkbook workbook, ICellStyle cellStyle)
        {
            ...
            else
            {
                ...
                {
                    //cellStyle
                    IndexedColors clr = IndexedColors.ValueOf(GetColourIndex(cellStyle.FillForegroundColor));
                ...
                {
                    IndexedColors clr = IndexedColors.ValueOf(GetColourIndex(cellStyle.FillBackgroundColor));
                    string hexstring = null;
                    if (clr != null)
                    {
                        hexstring = clr.HexString;
                ...
                String type, BorderStyle xlsBorder, short borderColor)
        {
            ...
            {
                IndexedColors clr = IndexedColors.ValueOf(GetColourIndex(borderColor));
                if (clr != null)
                {
                    borderStyle.Append(' ');
                ...
                IFont font)
        {
            ...
            {
                IndexedColors clr = IndexedColors.ValueOf(GetColourIndex(font.Color));
                string hexstring = null;
                if (clr != null)
                {
                    hexstring = clr.HexString;
